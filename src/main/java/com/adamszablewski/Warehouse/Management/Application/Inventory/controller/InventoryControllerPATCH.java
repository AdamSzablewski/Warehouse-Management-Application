...
public class InventoryControllerPATCH {
    ...
    @PatchMapping("/id/{inventory_id}/add/quantity/{amount}")
    ...
    @PatchMapping("/name/{name}/add/quantity/{amount}")
    ...
    @PatchMapping("/id/{inventory_id}/remove/quantity/{amount}")
    ...
    @PatchMapping("/name/{name}/remove/quantity/{amount}")
